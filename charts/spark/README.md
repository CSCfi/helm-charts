...
# Bitnami package for Apache Spark on Rahti 2
...
Based on [Bitnami Apache Spark](https://github.com/bitnami/charts/tree/main/bitnami/spark)
...
This chart bootstraps an [Apache Spark](https://github.com/bitnami/containers/tree/main/bitnami/spark) deployment on a [Rahti 2](https://landing.2.rahti.csc.fi/) cluster using the [Helm](https://helm.sh) package manager.
...
To install the chart with the release name `spark`:

```console
helm upgrade --install spark .
```

These commands deploy Apache Spark on the Openshift cluster in the default configuration. The [Parameters](#parameters) section lists the parameters that can be configured during installation.

> **Tip**: List all releases using `helm list`

## Uninstalling the Chart

To uninstall/delete the `spark` statefulset:
...
| ------------------------- | ----------------------------------------------- | ----- |
| `global.openshift.enabled`| Enable or not installation on Openshift         | `true`|
...
| `master.configOptions`                                     | Use a string to set the config options for in the form "-Dx=y"                                                           | `-Dspark.ui.reverseProxy=true`             |
...
| `master.podSecurityContext.enabled`                        | Enable security context                                                                                                  | `false`          |
...
| `master.containerSecurityContext.enabled`                  | Enabled containers' Security Context                                                                                     | `false`          |
...
| `worker.configOptions`                                     | Set extra options to configure the worker in the form `-Dx=y`                                                            | `-Dspark.ui.reverseProxy=true`             |
...
| `worker.podSecurityContext.enabled`                        | Enable security context                                                                                                  | `false`          |
...
| `worker.containerSecurityContext.enabled`                  | Enabled containers' Security Context                                                                                     | `false`          |
...
| `route.tls.termination`                   | Spark client port for HTTP                                                                                                | `edge`                   |
| `route.tls.insecureEdgeTerminationPolicy` | Spark client port for HTTPS                                                                                               | `Redirect`               |
